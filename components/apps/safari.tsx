...
export default function Safari({ isDarkMode = true }: SafariProps) {
  const [url, setUrl] = useState("https://www.youtube.com/@Cactuxbeer")
  ...
  const socialLinks = [
    {
      title: "Instagram",
      url: "https://www.instagram.com/cactuxbeer/",
      icon: "/instagram.png",
    },
    {
      title: "YouTube",
      url: "https://www.youtube.com/@Cactuxbeer",
      icon: "/youtube.png",
    },
    {
      title: "Email",
      url: "mailto:pingmihir@outlook.com",
      icon: "/mail.png",
    },
  ]
  ...
  const frequentlyVisited = [
    ...
    {
      title: "Instagram",
      url: "https://instagram.com/cactuxbeer",
      icon: "/instagram.png",
    },
  ]
            ...
            <div className="p-8">
              ...
              <div className="mt-8 max-w-2xl mx-auto">
                <div className={`p-6 rounded-lg ${cardBg}`}>
                  <h3 className="text-xl font-semibold mb-4">Mihir Suthar - Portfolio</h3>
                  <p className="mb-4">
                    Book a call to elevate your business with Me!
                    Contact : pingmihir@outlook.com
                  </p>
                  <p className="mb-4">
                   Don't forget to check out the snake game!
                  </p>
