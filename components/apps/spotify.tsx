  ...
  return (
    <div className="relative h-full overflow-hidden">
      ...
      <img
        ...
        alt=""
        className="absolute inset-0 w-full h-full object-cover scale-125 blur-[120px]"
      />
      ...
      <div className="relative z-10 h-full flex flex-col text-white">
        {/* Header */}
        <div className="p-4 flex items-center justify-between bg-black/20 backdrop-blur-xl border-b border-white/10">
